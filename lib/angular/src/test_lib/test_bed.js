System.register(["rtts_assert/rtts_assert", "angular2/di", "angular2/src/facade/lang", "angular2/src/facade/async", "angular2/src/facade/collection", "angular2/src/core/annotations/view", "angular2/src/core/compiler/template_resolver", "angular2/src/core/compiler/view", "angular2/src/core/compiler/dynamic_component_loader", "./utils", "./lang_utils"], function($__export) {
  "use strict";
  var assert,
      Injector,
      bind,
    ...
    execute: function() {
      TestBed = (function() {
        ...
        return ($traceurRuntime.createClass)(TestBed, {
          ...
          createView: function(component) {
            ...
            return assert.returnType((this._injector.get(DynamicComponentLoader).loadIntoNewLocation(componentBinding, null, rootEl, this._injector).then((function(hostComponentRef) {
      ...
      ViewProxy = (function() {
        function ViewProxy(componentRef) {
          assert.argumentTypes(componentRef, ComponentRef);
